...
export default function RegisterPage() {
  ...
  return (
    <div style={{ maxWidth: 400, margin: '100px auto', padding: 40, background: '#fff', borderRadius: 12, boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
      <h1 style={{ margin: 0, fontSize: 28, color: '#1F2937' }}>Create Account</h1>
      <p style={{ margin: '8px 0 24px', color: '#6B7280' }}>Sign up to get started</p>
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ marginBottom: 24 }}>
          <label style={{ display: 'block', marginBottom: 4, fontSize: 14, color: '#374151' }}>Confirm Password</label>
          <input
            type="password"
      ...
      <p style={{ marginTop: 24, textAlign: 'center', fontSize: 14 }}>
        <Link to="/login" style={{ color: '#3B82F6' }}>Already have an account? Login</Link>
      </p>
    </div>
  );
}
